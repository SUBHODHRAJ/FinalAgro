            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col items-center">
                  <img
                    ...
                    alt="Healthy Crop"
                    className="w-full h-28 object-cover rounded-lg shadow border-2 border-green-200 mb-2"
                  />
                  <div className="flex items-center space-x-1">
                    <CheckCircle className="w-4 h-4 text-green-600" />
                    <span className="text-green-700 text-xs font-semibold">Healthy</span>
                  </div>
                </div>

                <div className="flex flex-col items-center">
                  <img
                    src={mockResult.reference.earlyStage}
                    alt="Early Stage Disease"
                    className="w-full h-28 object-cover rounded-lg shadow border-2 border-yellow-200 mb-2"
                  />
                  <div className="flex items-center space-x-1">
                    <AlertCircle className="w-4 h-4 text-yellow-600" />
                    <span className="text-yellow-700 text-xs font-semibold">Early Stage</span>
                  </div>
                </div>

                <div className="flex flex-col items-center">
                  <img
                    src={mockResult.reference.moderate}
                    alt="Moderate Disease"
                    className="w-full h-28 object-cover rounded-lg shadow border-2 border-orange-200 mb-2"
                  />
                  <div className="flex items-center space-x-1">
                    <AlertCircle className="w-4 h-4 text-orange-600" />
                    <span className="text-orange-700 text-xs font-semibold">Moderate</span>
                  </div>
                </div>

                <div className="flex flex-col items-center">
                  <img
                    src={mockResult.reference.severe}
                    alt="Severe Disease"
                    className="w-full h-28 object-cover rounded-lg shadow border-2 border-red-200 mb-2"
                  />
                  <div className="flex items-center space-x-1">
                    <AlertCircle className="w-4 h-4 text-red-600" />
                    <span className="text-red-700 text-xs font-semibold">Severe</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <p className="text-blue-700 text-sm">
                  These reference photos show the progression of the disease from healthy to severe stages. Use them to identify symptoms and understand the severity level.
                </p>
              </div>
            </div>
          </motion.div>
